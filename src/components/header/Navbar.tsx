...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50 px-3 sm:px-5 lg:px-6 py-2.5">
      <div className="w-full max-w-[1920px] 2xl:max-w-[2400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Logo & Title */}
