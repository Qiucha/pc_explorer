...
export const enAssemblySteps: AssemblyStepTextContent[] = [
  {
    "step": 1,
    "partId": "cpu",
    "title": "Install CPU into Motherboard Socket",
    "instruction": "Lift the metal tension arm and swing the socket load plate open. Gently align the golden corner triangle on the CPU with the embossed dot on the socket frame. Lower it with Zero Insertion Force (ZIF). Close the load plate and press the lever arm down under the retention hook.",
    "checklist": [
  ...
  },
  {
    ...
    "instruction": "Push open the plastic latches at the ends of DIMM slots 2 and 4. Align the offset notch on the bottom edge of the memory stick with the ridge in the slot. Apply firm, even pressure with both thumbs until the latches snap upward with an audible double-click.",
    "checklist": [
  ...
  },
  {
    ...
    "instruction": "Peel the protective plastic film from the copper baseplate of the cooler! Apply a pea-sized dot of thermal paste to the center of the CPU IHS. Lower the cooler onto the mounting bracket and tighten the screws in an alternating diagonal pattern (X-pattern) to equalize pressure. Plug the 4-pin fan cable into the CPU_FAN header.",
    "checklist": [
  ...
  },
  {
    ...
    "instruction": "Verify that brass standoffs are installed in the chassis ONLY where your motherboard has screw holes. Align the rear I/O shield with the case opening, slide the motherboard into place against the standoffs, and secure all 9 screws with a magnetic screwdriver.",
    "checklist": [
  ...
  },
  {
    ...
    "instruction": "Connect the thick 24-pin ATX power harness to the right motherboard edge. Connect the 8-pin (4+4) EPS cable to the top-left CPU power header. Connect dedicated 8-pin PCIe or 12VHPWR cables to the GPU. Finally, connect the front panel POWER_SW wire leads to the JFP1 header pins.",
    "checklist": [
...
export const enDiagnosticCases: DiagnosticCaseTextContent[] = [
  {
