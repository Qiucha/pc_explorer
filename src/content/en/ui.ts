...
export const enUI: UITextContent = {
  ...
  wiring: {
    ...
    powerTab: 'Power Delivery (PSU)',
    dataTab: 'External Data Cables',
    boardDataTab: 'On-Board Data Flow (PCB)',
    powerSubtitle: 'Heavy gauge DC voltage rails carrying high amperage from the PSU to energize motherboard VRMs, GPU, and drives.',
    dataSubtitle: 'High-speed digital differential signaling and logic cables connecting chassis I/O and drives to the motherboard.',
    boardDataSubtitle: 'Internal high-speed PCB trace highways connecting the CPU, RAM, primary PCIe slot, and the motherboard chipset.',
    powerRule: 'Core Principle: Power cables originate from the Power Supply Unit (PSU) and convert 110V/220V AC into regulated +12V, +5V, and +3.3V DC.',
    dataRule: 'Core Principle: External data cables plug into the Motherboard without carrying high-current power loads.',
    boardDataRule: 'Core Principle: Speed-critical devices (RAM, Top GPU slot, Top M.2 NVMe) connect directly to CPU silicon. Lower-speed devices (SATA, USB, Audio, Wi-Fi) multiplex through the Motherboard Chipset via the DMI highway.',
    psuRailsGuide: 'PSU Voltage Rails & Color Code Demystifier',
    psuRailsHint: 'Decode what +12V, +5V, +3.3V, GND, and PS_ON# pins do inside your system.',
    dataIntegrityTitle: 'Data Bus & Signal Pin Integrity Rules',
    dataIntegrityDesc: 'High-speed digital pins are sensitive to harsh bends, electrostatic discharge, and bent socket pins (especially USB 3.0 19-pin headers). Handle data cables by the molded collar.',
    directVsChipsetTitle: 'Direct CPU Lanes vs. Chipset Multiplexing Demystifier',
    directVsChipsetHint: 'Understand why the top slot is faster and how the chipset prevents CPU pin congestion.',
    directCpuBadge: 'Direct CPU Silicon Link',
    chipsetRoutedBadge: 'Chipset Multiplexed',
    busProtocol: 'Bus Architecture & Protocol',
    bandwidthLabel: 'Theoretical Bandwidth',
    latencyLabel: 'Access Latency',
    whyItMatters: 'Beginner Engineering Insight (Why Slot Location Matters)',
    flowProfile: 'ON-BOARD HIGHWAY PROFILE',
    selectCable: 'Select Cable Harness',
    selectFlow: 'Select On-Board Data Highway',
    from: 'Source',
    to: 'Destination',
